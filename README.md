...
This is a web app that allows you to keep track of books from a book API.
...
The provided file [`BooksAPI.js`](src/BooksAPI.js) contains the methods that perform necessary operations on the backend:
